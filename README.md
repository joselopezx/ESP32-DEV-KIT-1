...
La herramienta utilizada para programar y subir el programa a nuestra tarjeta es ArduinoIDE el cual es gratuito y se descarga de la sigueinte liga : https://www.arduino.cc/en/software/
